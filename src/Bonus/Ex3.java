...
public class Ex3 {
    ...
    public static void resultText(ArrayList<String> data) throws IOException{

        try(BufferedWriter outputFile = new BufferedWriter(new FileWriter("Result - Bonus.txt"))) {
